\chapter{Les deux Gaspards}

\lettrine[ante=—]{\accentletter[\gravebox]{A}}{} quoi songez-vous, d'Artagnan, dit-il, et quelle pensée vous fait sourire?
...
— Oui, certes, et plus d'une fois je les ai regrettés. C'était un heureux temps, \textit{delectabile tempus!}
...
— Voilà donc, poursuivit Aramis, quelle était mon opinion première; mais comme je suis fort ignorant dans ces sortes de matières et que l'humilité dont je fais profession m'impose la loi de ne pas m'en rapporter à mon propre jugement, je me suis informé. Eh bien! mon cher ami\dots
...
— Heu! heu! fit Aramis, ils ont quelques discussions ensemble justement en ce moment-ci. Mais d'ailleurs, si ce n'est M.~le Prince, M.~de Gondy\dots
...
— Oui, reprit Aramis, malheureusement c'est un temps passé\dots \textit{fugit irreparabile tempus \dots}

— Bah! dit d'Artagnan, il reviendra peut-être. En tout cas, si vous avez besoin de moi, rue Tiquetonne, hôtel de \textit{La Chevrette.}
...
— Cela m'agréerait fort, au contraire, dit Aramis, si j'étais un homme comme un autre, mais, je vous le répète, en vérité je suis un composé de contrastes: ce que je hais aujourd'hui, je l'adorerai demain, et \textit{vice versa.} Vous voyez bien que je ne puis m'engager comme vous, par exemple, qui avez des idées arrêtées.
...
— Oh! dit une autre voix que d'Artagnan reconnut pour celle d'Aramis, je vous jure bien, princesse, que si notre renommée ne dépendait pas de toutes ces précautions, et que je n'y risquasse que ma vie\dots
...
\begin{bwbigpic}
	[\basicscale] 
	{chap09hat}
	[Un chapeau sur la tête et un à la main]
\end{bwbigpic}
