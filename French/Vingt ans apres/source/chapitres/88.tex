\chapter{L'esprit et le bras}

\lettrine{M}{aintenant} passons de l'orangerie au pavillon de chasse.
...
\begin{bwbigpic}
	[\basicscale] 
	{chap83supper}
	[Un sergent et deux hommes portaient le souper dans une manne]
\end{bwbigpic}