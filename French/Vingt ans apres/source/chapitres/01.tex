\chapter{Le fantôme de Richelieu}

\lettrine{D}{ans} une chambre du palais Cardinal que nous connaissons déjà, près d'une table à coins de vermeil, chargée de papiers et de livres, un homme était assis la tête appuyée dans ses deux mains.
...
Alors, pour \textit{voir}, on avait assemblé le conseil et l'on avait envoyé chercher le surintendant des finances d'Emery.
...
\begin{bwbigpic}
	[\basicscale] 
	{chap01maninblack}
	[Un homme vêtu de noir s'avança]
\end{bwbigpic}
