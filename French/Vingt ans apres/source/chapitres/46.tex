\chapter{Où il est prouvé que le premier mouvement est toujours le bon}

\lettrine{L}{es} trois gentilshommes prirent la route de Picardie, cette route si connue d'eux, et qui rappelait à Athos et à Aramis quelques-uns des souvenirs les plus pittoresques de leur jeunesse.
...
— Mais cependant si c'est un espion\dots
...
\begin{bwbigpic}
	[\basicscale] 
	{chap43recognized}
	[Le soleil ne laissait plus qu'un nuage d'or]
\end{bwbigpic}
...
— Rien, dit de Winter, rien. Cependant, en passant près des dunes, il m'a semblé\dots
