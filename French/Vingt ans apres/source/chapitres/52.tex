\chapter{Le malheur donne de la mémoire}

\lettrine{A}{nne} était rentrée furieuse dans son oratoire.
...
— Et ils ne me pendront pas, \textit{benone.}
...
— Je ris très peu, la guerre est dangereuse avec tout un peuple: voyez votre frère Charles~I\textsuperscript{er}, il est mal, très mal.

— Nous sommes en France et je suis Espagnole.

— Tant pis, \textit{per Baccho}, tant pis, j'aimerais mieux que vous fussiez française, et moi aussi: on nous détesterait moins tous les deux.
...
— Moi! je suis toujours prêt à partir; seulement, vous le savez, je ne pars jamais\dots et cette fois probablement pas plus que les autres.
...
\begin{bwbigpic}
	[\basicscale] 
	{chap49window}
	[Mazarin prit la main de la reine et la conduisit à la fenêtre]
\end{bwbigpic}
