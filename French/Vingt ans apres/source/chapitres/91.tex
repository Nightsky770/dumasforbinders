\chapter{Le bras et l'esprit (Suite)}

\lettrine{P}{orthos} s'approcha de la fenêtre, prit un barreau à deux mains, s'y cramponna, l'attira vers lui et le fit plier comme un arc, si bien que les deux bouts sortirent de l'alvéole de pierre où depuis trente ans le ciment les tenait scellés.
...
— Cependant, j'aurais préféré\dots
...
Montez dessus\dots Là, bien, c'est cela, mon ami.
...
\begin{bwbigpic}
	[\basicscale] 
	{chap84pincers}
	[Son poignet d'acier mordit le cou du soldat]
\end{bwbigpic}
...
D'Artagnan était fort connu de ce valet de chambre, qui n'était autre que Bernouin, qui, depuis six ou huit mois, l'avait introduit une dizaine de fois près du cardinal. Il se contenta donc, au lieu de répondre, de grommeler le \textit{ia} le moins gascon et le plus allemand possible.

Quant à Porthos, d'Artagnan avait exigé et obtenu de lui la promesse qu'en aucun cas il ne parlerait. S'il était poussé à bout, il lui était permis de proférer pour toute réponse le \textit{tarteifle} proverbial et solennel.
...
— Voilà une belle difficulté! dit Porthos, et avec un coup d'épaule\dots
...
—\textit{Ia}, répliqua le Gascon, déterminé à se borner à cet échantillon de la langue allemande.

— \textit{Tedesco}, fit le cavalier, \textit{va bene.}
