\chapter{La veille de la bataille}

\lettrine{R}{aoul} fut tiré de ces sombres réflexions par l'hôte, qui entra précipitamment dans la chambre où venait de se passer la scène que nous avons racontée, en criant:
...
—\textit{ Ich bin ein Deutscher}, répondit le prisonnier.
...
— \textit{Non siete Spagnuolo}, dit-il, \textit{non siete Tedesco, siete Italiano.}
...
\begin{bwbigpic}
	[\basicscale] 
	{chap34princehorse}
	[Le paysan partit, courant devant le cheval du prince]
\end{bwbigpic}
