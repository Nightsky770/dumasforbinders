\chapter{La partie de lansquenet}

\lettrine{E}{n} effet, il était neuf heures du soir; les postes avaient été relevés à huit, et depuis une heure la garde du capitaine Groslow avait commencé.
...
— \textit{Very good!} dit Groslow, et il ouvrit la porte de la chambre. C'est pour vous montrer le chemin, messieurs, dit-il.
...
\begin{bwbigpic}
	[\basicscale] 
	{chap61parryseated}
	[Charles était sur son lit tout habillé]
\end{bwbigpic}
...
Et, malgré sa puissance sur lui-même, il y avait dans la voix de d'Artagnan une vibration étrange qui fit tressaillir son \textit{partner}.
