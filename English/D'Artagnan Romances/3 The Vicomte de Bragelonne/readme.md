...
Source files are in the "source" directory. You do not need them unless you are producing your own version. I am using LuaLaTeX.
...
* Overall: I have placed all pub names in quotes. I have italicized French interjections to be consistent with the other books. I have also italicized these French words, again for consistency with other books:
  ...
  * brevet
  * bourgeois/e
* Chapter 1: I have capitalized "Grand Veneur", which was an actual royal position in prerevolutionary France. (https://en.wikipedia.org/wiki/Grand_Huntsman_of_France)
* Chapter 4: I have added a footnote to Dumas' use of "gasgachau" as an alleged Arabic onomatopoeia equivalent to English "splash". Nobody on the internet seems to think this is an actual Arabic word.
* Chapter 11: I have footnoted "cousin-german" as "First cousin".
