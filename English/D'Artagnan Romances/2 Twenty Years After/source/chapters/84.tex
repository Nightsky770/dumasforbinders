...
<Good, the execution of plots is my \binderyfrench{forte}.>
...
<In a moment the \binderyfrench{valet-de-chambre} will call the guard, as he did yesterday and the day before.>
...
Scarcely had the two Frenchmen touched the ground when a door opened and the voice of the \binderyfrench{valet-de-chambre} called out:
...
<Where are you?> asked the \binderyfrench{valet-de-chambre}, whose eyes, dazzled by the light, could not clearly distinguish our heroes in the gloom.
...
These two newly enlisted soldiers marched gravely after the \binderyfrench{valet-de-chambre}, who opened the door of the vestibule, then another which seemed to be that of a waiting-room, and showing them two stools:
...
<\binderyitalian{Tedesco!}> answered the cavalier; <\binderyitalian{va bene}.\footnote{<A German! Go well.>}>
